...
/*
     creado aqui mismo porque solo va ser usado a este nivel
     para el mapeo de como y cuanto queremos mostrarle al cliente de los errores
     de bad request por falta de llenar campos del objeto o null

     es FieldError por que getAllErrors es de ese tipo de objeto
     cuando se selecciona getAllErrors al frente esta el tipo de objeto que corresponde
 */
